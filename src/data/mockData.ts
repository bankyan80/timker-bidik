...
export const MOCK_ALERTS: AlertMessage[] = [
  {
    id: 'alt-1',
    timestamp: '08:02',
    schoolName: 'SDN 1 Belawa',
    severity: 'CRITICAL',
    message: 'Teacher shortage threshold breached: Student-to-Teacher ratio is 28:1 (Ideal: 20:1)',
    category: 'Staffing'
  },
  {
    id: 'alt-2',
    timestamp: '08:15',
    schoolName: 'SDN 1 Picungpugur',
    severity: 'WARNING',
    message: 'Certification delays detected for 3 verified subject teachers (Pending validation stage > 3 months)',
    category: 'Certification'
  },
  {
    id: 'alt-3',
    timestamp: '09:00',
    schoolName: 'SDN 1 Wangkelang',
    severity: 'CRITICAL',
    message: 'Heavy infrastructure damage: Classroom Roof Collapsed in Class 4 & Class 5 building blocks',
    category: 'Infrastructure'
  },
  {
    id: 'alt-4',
    timestamp: '10:30',
    schoolName: 'SDN 1 Cipeujeuh Wetan',
    severity: 'WARNING',
    message: 'Retirement Exposure: 2 out of 7 teachers reaching retirement age in 2027 with 0 replacement assigned',
    category: 'Staffing'
  },
  {
    id: 'alt-5',
    timestamp: '11:45',
    schoolName: 'SDN 2 Lemahabang',
    severity: 'INFO',
    message: 'Accreditation Renewal Due: Profile and facility documents validation pending for BAN-PDM review',
    category: 'Document'
  }
];
...
export const MOCK_RECOMMENDATIONS: Recommendation[] = [
  {
    id: 'rec-1',
    title: 'Teacher Redistribution & Urgent Placement',
    description: 'Assign 5 PPPK/certified class teachers to Belawa & Wangkelang villages to resolve structural deficit and reduce student-to-teacher ratio from 28:1 to 20:1.',
    urgency: 'High',
    impactScore: 88,
    estimatedCostMiliar: 0.25,
    timelineMonths: 3,
    category: 'Staffing',
    applied: false
  },
  {
    id: 'rec-2',
    title: 'Emergency Classroom Rehabilitation',
    description: 'Provide immediate rehabilitation funding for 7 critical classrooms with heavy structural damage in SDN 1 Wangkelang and SDN 1 Picungpugur.',
    urgency: 'Critical',
    impactScore: 95,
    estimatedCostMiliar: 1.2,
    timelineMonths: 6,
    targetSchoolNpsn: '20215164',
    category: 'Infrastructure',
    applied: false
  },
  {
    id: 'rec-3',
    title: 'Accelerate Pending Teacher Certifications',
    description: 'Fast-track regional verification for 84 pending teacher certifications currently stuck in the validation phase at the Cirebon Regency level.',
    urgency: 'Medium',
    impactScore: 78,
    estimatedCostMiliar: 0.05,
    timelineMonths: 2,
    category: 'Certification',
    applied: false
  },
  {
    id: 'rec-4',
    title: 'Strategic School Merging Program',
    description: 'Merge SDN 2 Cipeujeuh Wetan with SDN 1 Cipeujeuh Wetan to optimize class sizes, pool teaching personnel, and reduce operational costs by 30%.',
    urgency: 'Medium',
    impactScore: 82,
    estimatedCostMiliar: 0.15,
    timelineMonths: 12,
    category: 'Governance',
    applied: false
  }
...
export const MOCK_DOCUMENTS: DocumentMeta[] = [
  {
    id: 'doc-1',
    title: 'Akreditasi SDN 1 Lemahabang 2025.pdf',
    category: 'Accreditation',
    schoolName: 'SDN 1 Lemahabang',
    schoolNpsn: '20214479',
    lastUpdated: '2025-11-12',
    status: 'Complete',
    ocrContentSample: 'SURAT KEPUTUSAN BADAN AKREDITASI NASIONAL SEKOLAH/MADRASAH Nomor: 1347/BAN-SM/SK/2025 menyatakan SDN 1 Lemahabang Terakreditasi Peringkat A (Unggul) dengan nilai akhir 94.',
    anomaliesDetected: []
  },
  {
    id: 'doc-2',
    title: 'Laporan Realisasi BOS Triwulan II SDN 1 Cipeujeuh Wetan.xlsx',
    category: 'BOS',
    schoolName: 'SDN 1 Cipeujeuh Wetan',
    schoolNpsn: '20215216',
    lastUpdated: '2026-05-10',
    status: 'Action Required',
    ocrContentSample: 'LAPORAN REKAPITULASI PENGGUNAAN DANA BOS REGULER TAHAP II. Total Alokasi: Rp 85.000.000. Realisasi: Belanja Jasa Honor Pendidik Rp 42.000.000, Belanja Pemeliharaan Sarana Prasarana Rp 35.000.000. Selisih tidak teralokasi: Rp 8.000.000.',
    anomaliesDetected: ['Discrepancy in unallocated budget amount: Rp 8,000,000 listed without supporting invoice lines']
  },
  {
    id: 'doc-3',
    title: 'Rencana Rehabilitasi Ruang Kelas SDN 1 Picungpugur.pdf',
    category: 'Facility',
    schoolName: 'SDN 1 Picungpugur',
    schoolNpsn: '20214726',
    lastUpdated: '2026-06-01',
    status: 'Draft',
    ocrContentSample: 'PROPOSAL PERBAIKAN RUANG KELAS RUSAK BERAT. Ruang Kelas 3, Kelas 4, dan Kelas 5 mengalami kerusakan atap bocor, dinding retak struktural, lantai amblas. Diperlukan anggaran Rp 450.000.000 untuk rekonstruksi total.',
    anomaliesDetected: []
  },
  {
    id: 'doc-4',
    title: 'Data Sarana Prasarana SDN 1 Wangkelang.pdf',
    category: 'Facility',
    schoolName: 'SDN 1 Wangkelang',
    schoolNpsn: '20215164',
    lastUpdated: '2026-04-18',
    status: 'Missing',
    ocrContentSample: '[WARNING] Document contains structural placeholders. Internet connectivity audit, sanitation data, and laboratory capacity entries are empty.',
    anomaliesDetected: ['Sanitation compliance metrics missing', 'Digital teaching equipment ledger empty']
  },
  {
    id: 'doc-5',
    title: 'Permendikbud Ristek RI No 48 Tahun 2023.pdf',
    category: 'Regulation',
    lastUpdated: '2023-12-15',
    status: 'Complete',
    ocrContentSample: 'PERATURAN MENTERI PENDIDIKAN, KEBUDAYAAN, RISET, DAN TEKNOLOGI REPUBLIK INDONESIA NOMOR 48 TAHUN 2023 Tentang Standar Pelayanan Minimal Pendidikan Pada Daerah Kabupaten/Kota.',
    anomaliesDetected: []
  }
];
